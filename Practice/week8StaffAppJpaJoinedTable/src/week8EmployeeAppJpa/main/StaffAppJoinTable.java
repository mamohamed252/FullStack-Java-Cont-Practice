...
public class StaffAppJoinTable extends abstractEmp{
	...
	private static void testRegisterStaff() throws SQLException {
		...
		Staff staff = new Staff(1,"Mohamed", "test");
		TeachingStaff teachingstaff = new TeachingStaff(5, "Kevin", "Dave", "PM");
		NonTeachingStaff nonTeach = new NonTeachingStaff(6, "test", "Testing", "tet");
